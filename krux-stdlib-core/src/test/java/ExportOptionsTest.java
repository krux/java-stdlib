...
public class ExportOptionsTest {
    ...
    private static String asPropertyValue(List<?> values, boolean present) {
        ...
        return values.isEmpty() ? String.valueOf(present) : StringUtils.join(values, ",");
    }
    ...
    public void allowsExportOfOptions() {
        ...
        // Cannot check path as string directly - Windows flips the leading
        // slash
        ...
        System.out.println(asProperties(options, "rice"));
    }
}