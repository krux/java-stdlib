...
public class LoggerConfigurator {
    ...
    public static void configureRotatingLogging() {
        configureRotatingLogging(KruxStdLib.get());
    }

    public static void configureRotatingLogging(KruxStdLib stdLib) {
        configureRotatingLogging(stdLib.getBaseAppDir(), stdLib.getLogLevel(), stdLib.getAppName());
    }
